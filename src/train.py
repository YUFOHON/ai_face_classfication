...
if __name__ == '__main__':
    ...
    best_loss = float('inf')
    patience = 30  # Number of epochs to wait before stopping if the validation loss doesn't improve
    ...
    for epoch in range(epochs):
        ...
        if valid_epoch_loss < best_loss:
            ...
            early_stopping_counter = 0
            save_model(epochs, model, optimizer, criterion)  # Save the best model
        else:
